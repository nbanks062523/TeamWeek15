...
DATA_FILES = {
    'food_inflation_BM': os.path.join(DATA_DIR, config['FoodInflation']),
    'grocery_prices_BM': os.path.join(DATA_DIR, config['MonthlyGroceryPrices']),
    'snap_poverty_pop': os.path.join(DATA_DIR, config['SNAPNum_Pov']),
    'snap_population': os.path.join(DATA_DIR, config['SNAPPop']),
    'snap_program_part': os.path.join(DATA_DIR, config['SNAPPrgPartc']),
}
